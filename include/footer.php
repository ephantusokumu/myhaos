<footer class="footer">
    <div class="container footer-inner">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        ...
                        <li>
                            Email: <a href="mailto:info@myhao.co.ke">info@myhao.co.ke</a>
                        </li>
                        <li>
                            Phone: <a href="tel:+0477-85x6-552">+2547131792842</a>
                        </li>
                    </ul>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item clearfix">
                    ...
                    <div class="Subscribe-box">
                        <p>Drop your email for exclusive listings and offers</p>
        ...
        <div class="row">
            <div class="col-xl-12">
                <p class="copy">&copy;  2020 <a href="http://myhao.co.ke/" target="_blank">MyHao</a> - A trademark in the Market</p>
            </div>
        </div>
    </div>
</footer>
